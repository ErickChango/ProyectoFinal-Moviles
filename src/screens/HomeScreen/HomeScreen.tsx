...
export const HomeScreen = () => {
    const products: Product[] = [
        { id: 1, name: 'Tarjeta Grafica NVIDIA GeForce RTX 4090', price: 1599.99, stock: 5, pathImage: 'https://m.media-amazon.com/images/I/711vU2IrEuL._AC_SL1500_.jpg' },
        ...
        { id: 6, name: 'Teclado Mecanico Razer BlackWidow V4 Pro', price: 229.99, stock: 12, pathImage: 'https://http2.mlstatic.com/D_NQ_NP_888395-MLU74523092241_022024-O.webp' },
        { id: 7, name: 'Raton Logitech G502 HERO', price: 49.99, stock: 30, pathImage: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRuVcWZzM-b48nqn6JjAa4T4DHP_MHL_A9kmA&s'},
    ...
    { id: 15, name: 'Microfono de Condensador Blue Yeti X', price: 169.99, stock: 9, pathImage: 'https://japon.vtexassets.com/arquivos/ids/167139/Microfono-Profesional-Logitech-Blue-Yeti-X.jpg?v=638681504497530000' },
    ...
    const updateStock = (item: Product, quantity: number) => {
      ...
      // actualiza el contador del carrito con la cantidad total de items
    ...
    const resetCart = () => {
        // Al presionar el boton de comprar reinicia el carrito el contador y cierra el modal

        setCart([]);
        setCartCount(0);
        setModalVisible(false);
        Alert.alert('Exito', '¡La compra se ha realizado con exito!');
    };
        ...
        <>
            ...
            <SafeAreaView style={{ flex: 1, backgroundColor: PRIMARY_COLOR }}>
                <View style={styles.header}>
                    ...
                    <TouchableOpacity
                        onPress={cart.length > 0 ? () => setModalVisible(!modalVisible) : () => Alert.alert('Carrito Vacio', 'Agrega productos al carrito para continuar.')}
                        style={{
